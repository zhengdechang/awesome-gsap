      ...
      <div className="section-wrapper h-[calc(100vh-65px)]" ref={wrapperRef}>
        <div className="headline flex flex-col items-center" ref={headlineRef}>
          <div className="turbo-os relative w-[180px] h-[180px] mx-auto overflow-hidden rounded-full">
            <div className="fill-top absolute top-0 left-0 w-full h-1/2 bg-gradient-to-r from-blue-500 to-cyan-500"></div>
            <div className="fill-bottom absolute bottom-0 left-0 w-full h-1/2 bg-gradient-to-r from-indigo-500 to-purple-500"></div>
        ...
        <div className="section-content flex justify-center items-center gap-16 text-white">
          <div className="tower-icon w-24 h-24 bg-white/20 rounded-full flex items-center justify-center">
            <span className="text-4xl">📡</span>
          </div>
          <div className="improved text-center">
            <p className="subtitle text-[2vw] mb-4 text-white">
              蜂窝网络数据卡顿率
            </p>
            <div className="ratio flex items-center justify-center gap-2">
              <span className="text-red-400 text-3xl">↓</span>
              <p className="text-[4vw] font-bold text-white">83%</p>
            </div>
          </div>
          <div className="tower-icon w-24 h-24 bg-blue-500/50 rounded-full flex items-center justify-center">
            <span className="text-4xl">📶</span>
          </div>
        </div>
      </div>
