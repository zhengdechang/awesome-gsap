      ...
      <div ref={contentRef} className="max-w-6xl mx-auto px-6 py-12">
        <div className="text-center">
          ...
          <div className="flex justify-center space-x-6 mb-8">
            {socialIcons.map((social, index) => (
              <a
                ...
                className="w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center text-gray-400 hover:text-white hover:bg-blue-600 transition-all duration-300 transform hover:scale-110"
          ...
          <div className="text-gray-400 text-sm">
            <p className="mb-2">
              Designed and Developed with ❤️ using GSAP
            </p>
            <p>
              © {new Date().getFullYear()} GSAP Folio. All rights reserved.
            </p>
          </div>
        </div>
      </div>
